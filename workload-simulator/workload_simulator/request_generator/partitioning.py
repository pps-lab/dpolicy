...
class Defaults:
    ...
    @staticmethod
    def new_ultra_highly_partitioned(schema: Schema, attribute_name="attr0"):
        """
        In almost all cases, the requests select only a single slot.
        """
        return IntervalPopulationSelection(schema, attribute_name=attribute_name, beta_a=1, beta_b=100)


    @staticmethod
    def new_highly_partitioned(schema: Schema, attribute_name="attr0"):
        """
        """
        return IntervalPopulationSelection(schema, attribute_name=attribute_name, beta_a=1, beta_b=10)


    @staticmethod
    def new_ultra_low_partitioned(schema: Schema, attribute_name="attr0"):
        """
        In almost all cases, the requests select all slots.
        """
        return IntervalPopulationSelection(schema, attribute_name=attribute_name, beta_a=2**20, beta_b=2)

    @staticmethod
    def new_low_partitioned(schema: Schema, attribute_name="attr0"):
        """
        ...
        P(X<0.75)=0.5
        """
        return IntervalPopulationSelection(schema, attribute_name=attribute_name, beta_a=1, beta_b=0.5)

    @staticmethod
    def new_quadratic_partitioned(schema: Schema, attribute_name="attr0"):
        """
        ...
        """
        return IntervalPopulationSelection(schema, attribute_name=attribute_name, beta_a=0.5, beta_b=0.5)


    @staticmethod
    def new_normal_partitioned(schema: Schema, attribute_name="attr0"):
        """
        In expectation, requests select 0.5 of the slots.
        (function looks like a normal distribution and thus most of the time selects a percentage around 0.5)
        """
        return IntervalPopulationSelection(schema, attribute_name=attribute_name, beta_a=2, beta_b=2)
...
class IntervalPopulationSelection(BasePopulationSelection):
    ...
    def __post_init__(self):
        ...
        attr = self.schema.get_attribute(self.attribute_name)

        self.domain = attr.value_domain
