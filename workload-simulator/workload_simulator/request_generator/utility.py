...
class BaseUtilityAssigner(ABC):
    ...
    @abstractmethod
    def assign_utility(self, requests: List[dict], seed=None):
        pass
...
class ConstantUtilityShadowAssigner(BaseUtilityAssigner):
    ...
    def assign_utility(self, requests: List[Request], seed=None):
...
class NormalizedCobbDouglasUtilityAssigner(BaseUtilityAssigner):
    ...
    def __init__(self, privacy_cost_elasticity, data_elasticity, scaling_beta_a, scaling_beta_b, use_balance_epsilon, utility_privacy_unit: str):
        ...
        self.utility_privacy_unit = utility_privacy_unit
    ...
    def assign_utility(self, requests: List[Request], seed=None):
        ...
        scalings = beta.rvs(self.scaling_beta_a, self.scaling_beta_b, size=len(requests), random_state=gen)

        def get_cost(req):
            return req.request_info.cost_original.adp[self.utility_privacy_unit.name]["EpsDeltaDp"]
